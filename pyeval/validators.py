...
class TypeValidator(Validator):
    ...
    def validate(self, value: Any) -> ValidationResult:
        ...
        if not isinstance(value, self.types):
            result.add_error(f"Expected type {self.types}, got {type(value).__name__}")
        return result
...
class ListValidator(Validator):
    ...
    def __init__(
        self, element_type: type = None, min_length: int = None, max_length: int = None
    ):
...
class DictValidator(Validator):
    ...
    def validate(self, value: Any) -> ValidationResult:
        ...
        all_keys = (
            ...
            | set(self.optional_keys)
            | set(self.value_types.keys())
        )
...
class PredictionValidator(Validator):
    ...
    def __init__(
        self, require_same_length: bool = True, require_non_empty: bool = True
    ):
...
def validate_predictions(
    y_true: List, y_pred: List, raise_on_error: bool = True
) -> ValidationResult:
    """
...
def validate_probabilities(
    probs: List, require_sum_one: bool = False, raise_on_error: bool = True
) -> ValidationResult:
    """
