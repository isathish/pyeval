...
def confusion_matrix_display(
    matrix: List[List[int]], labels: Optional[List[str]] = None, width: int = 80
) -> str:
    """
...
def classification_report_display(
    y_true: List[Any],
    y_pred: List[Any],
    ...
    if total_support > 0:
        ...
        lines.append(
            f"{'Macro avg':15} {macro_precision:>10.4f} {macro_recall:>10.4f} {macro_f1:>10.4f} {total_support:>10}"
        )
        lines.append(
            f"{'Weighted avg':15} {weighted_precision:>10.4f} {weighted_recall:>10.4f} {weighted_f1:>10.4f} {total_support:>10}"
        )
...
def horizontal_bar_chart(
    values: Dict[str, float], title: str = "Bar Chart", width: int = 50, char: str = "█"
) -> str:
    """
...
def score_distribution_display(
    scores: Dict[str, List[float]], title: str = "Score Distribution", width: int = 60
) -> str:
    """
...
def error_analysis_display(
    errors: List[Dict[str, Any]], max_show: int = 10, width: int = 80
) -> str:
    """
