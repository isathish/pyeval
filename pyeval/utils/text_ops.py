...
STOPWORDS = {
    ...
    'just', 'me', 'might', 'more', 'most', 'must', 'my', 'myself', 'no',
    'nor', 'not', 'now', 'of', 'on', 'or', 'other', 'our', 'ours', 'out',
...
LEMMA_RULES = {
    ...
    'geese': 'goose', 'leaves': 'leaf', 'lives': 'life',
...
def tokenize(text: str, lowercase: bool = True, remove_punct: bool = False) -> List[str]:
    """
...
def lemmatize(word: str) -> str:
    ...
    if word_lower.endswith('es') and len(word_lower) > 3:
        if word_lower.endswith('sses') or word_lower.endswith('xes') or \
           word_lower.endswith('ches') or word_lower.endswith('shes'):
            return word_lower[:-2]
...
def normalize_text(text: str, lowercase: bool = True, remove_punct: bool = True,
                   remove_numbers: bool = False, remove_extra_spaces: bool = True) -> str:
    """
...
def get_word_frequencies(text: str, lowercase: bool = True, 
                        remove_stopwords_flag: bool = False) -> Counter:
    """
