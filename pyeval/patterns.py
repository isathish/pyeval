...
class EvaluationPipelineBuilder:
    ...
    def add_preprocessing(self, func: Callable, *args, **kwargs):
        ...
        self._preprocessing.append(PipelineStep(
            name=func.__name__,
            func=func,
            args=args,
            kwargs=kwargs
    ...
    def add_metric(self, name: str, func: Callable, *args, **kwargs):
        ...
        self._metrics.append(PipelineStep(
            name=name,
            func=func,
            args=args,
            kwargs=kwargs
    ...
    def add_postprocessing(self, func: Callable, *args, **kwargs):
        ...
        self._postprocessing.append(PipelineStep(
            name=func.__name__,
            func=func,
            args=args,
            kwargs=kwargs
...
class EvaluationPipeline:
    ...
    def __init__(self, preprocessing: List[PipelineStep],
...
class LoggingObserver(EventObserver):
    ...
    def update(self, event_data: EventData):
        log_msg = f"[{event_data.event.value}] {event_data.metric_name}: {event_data.value}"
