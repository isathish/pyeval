...
class TestEvaluationReport:
    ...
    def test_create_report(self):
        ...
        report = EvaluationReport(
            name="Test Report", domain="ml", metrics={"accuracy": 0.95, "f1": 0.92}
        )
    ...
    def test_summary(self):
        ...
        report = EvaluationReport(name="Test", domain="ml", metrics={"accuracy": 0.95})
...
class TestEvaluatorIntegration:
    ...
    def test_full_evaluation_workflow(self):
        ...
        report1 = evaluator.evaluate_classification(
            y_true_cls, y_pred_cls, name="Classifier"
        )

        # Regression
        y_true_reg = [1.0, 2.0, 3.0, 4.0]
        y_pred_reg = [1.1, 2.2, 2.8, 4.1]
        report2 = evaluator.evaluate_regression(
            y_true_reg, y_pred_reg, name="Regressor"
        )
